...
<section>
    <div class="container row">
        <div class="col m6 offset-m3 l6 offset-l3 xl4 offset-xl4 s10 offset-s1 card card-login z-depth-4">
            <div class="card-title card-title-login lighten-2 white-black"><br>
            <h5 class="yellow-text text-darken-2 center">Laravel Project <i class="material-icons">lightbulb_outline</i> </h5>
            </div>
